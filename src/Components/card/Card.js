...
export default function Card(props) {
    ...
    return (
        ...
        <div>
            <div className="card user-card ho paper">
                ...
                <MDBCard>
                    ...
                    <MDBCardBody>
                        ...
                        <h5 className="card-title">{props.title}</h5>
                    <p className="card-text">{props.author}</p>
                    <a data-testid="cardbodyclass" href={props.url} target="_blank" className="btn user-Button mx-2">Open</a>
                    <MDBBtn type="submit" className="user-Button" onClick={() => {
                        saveNews();
                    }}>Later</MDBBtn>
                        </MDBCardText>
                    </MDBCardBody>
